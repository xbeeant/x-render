...
| widgets          | 自定义组件，当内置组件无法满足时使用，详见[Widgets](/form-render/advanced-widget)                             | `Record<string, ReactNode>`                                                                           | -      |
| watch            | 监听表单的数据变化，详见[Watch](/form-render/advanced-linkage#watch-listening)                                                   | `Record<string, (val: any) => void \| { handler:(val:any) => void,immediate?: boolean }>`             | -      |
...
| validateMessages | 修改默认的校验提示信息，详见[ValidateMessages](/form-render/advanced-validate#default-template-content)                         | `Record<string, string>`                                                                              | -      |
...
| validateFields    | 触发表单验证, [示例](/form-render/advanced-validate)                                                                                 | `(nameList?: Path[]) => Promise`                                                                                    |
